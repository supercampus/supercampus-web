...
import { listStudentMaster, setStudentPhoto, updateStudentMaster, uploadStudentPhoto, type StudentMasterRow } from '@/lib/student-master-api';
...
function StudentRecordDialog({ student, notify, onClose, onChanged }: { student: StudentMasterRow; notify: (message: string) => void; onClose: () => void; onChanged: (student: StudentMasterRow) => void }) {
  ...
  const [form, setForm] = useState(() => ({
    ...
    yearOfStudy: Number.parseInt(student.yearOfStudy ?? '1', 10) || 1,
