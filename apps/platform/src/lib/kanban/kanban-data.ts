...
export const COLUMNS: Column[] = [
  ...
  { id: 'contacted', title: 'Contacted', accent: '#776cf5' },
  { id: 'nurture', title: 'Nurture', accent: '#a600ff' },
  { id: 'qualified', title: 'Qualified', accent: '#1400ff' },
  { id: 'application', title: 'Application', accent: '#776cf5' },
  { id: 'application-status', title: 'Application Status', accent: '#de6cf5' },
  { id: 'deposit-payment', title: 'Deposit Payment', accent: '#ff005c' },
  { id: 'admitted', title: 'Admitted', accent: '#1400ff' },
  { id: 'archived', title: 'Archived', accent: '#6f6875' },
];
...
export const ROLES: UserRole[] = [
  ...
  },
  {
    ...
    permissions: ['application-status', 'deposit-payment'],
  },
  {
    id: 'finance-officer',
    name: 'Finance Officer',
    label: 'Finance Officer',
    permissions: ['deposit-payment', 'admitted'],
  },
  {
    id: 'principal',
...
export const LEADS: Lead[] = [
  ...
  },
  {
    ...
    moveHistory: [
      ...
      { id: 'm57', from: 'application-status', to: 'deposit-payment', by: 'user4', byName: 'Finance Officer', timestamp: ts(1), note: 'Fee deposit pending — follow up for payment' },
    ],
  },
  {
    id: 'L-1015',
    ...
    moveHistory: [
      ...
      { id: 'm65', from: 'application-status', to: 'deposit-payment', by: 'user4', byName: 'Finance Officer', timestamp: ts(1, 6), note: 'Deposit pending — parent wants to discuss payment plan' },
    ],
  ...
  },
  {
    ...
    moveHistory: [
      ...
      { id: 'm73', from: 'application-status', to: 'deposit-payment', by: 'user4', byName: 'Finance Officer', timestamp: ts(0, 12), note: 'Awaiting fee deposit' },
    ],
  },
  {
    id: 'L-1017',
    ...
    moveHistory: [
      ...
      { id: 'm81', from: 'application-status', to: 'deposit-payment', by: 'user4', byName: 'Finance Officer', timestamp: ts(8), note: 'Deposit made via UPI' },
      { id: 'm82', from: 'deposit-payment', to: 'admitted', by: 'principal', byName: 'Principal', timestamp: ts(2), note: 'Welcome to SuperCampus! Enrollment details shared.' },
    ],
  },
  {
    id: 'L-1018',
    ...
    moveHistory: [
      ...
      { id: 'm85', from: 'contact-attempted', to: 'archived', by: 'user3', byName: 'Karthik', timestamp: ts(15), note: 'Not interested — joined competitor institution' },
    ],
  },
  {
    id: 'L-1019',
    ...
    moveHistory: [
      ...
      { id: 'm88', from: 'contact-attempted', to: 'archived', by: 'user1', byName: 'Priya', timestamp: ts(20), note: 'No response after multiple attempts — spam' },
    ],
  },
  {
    id: 'L-1020',
  ...
  },
  {
    ...
    moveHistory: [
      ...
      { id: 'm115', from: 'application-status', to: 'deposit-payment', by: 'user4', byName: 'Finance Officer', timestamp: ts(10), note: 'Deposit completed' },
      { id: 'm116', from: 'deposit-payment', to: 'admitted', by: 'principal', byName: 'Principal', timestamp: ts(5), note: 'Admitted — orientation scheduled' },
    ],
  },
];
