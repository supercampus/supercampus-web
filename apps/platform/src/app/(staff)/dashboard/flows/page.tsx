...
import ModuleFlowExplorer from '@/components/modules/ModuleFlowExplorer';
...
export default async function ModuleFlowsPage() {
  const catalogs = await loadCatalogs();
  return <ModuleFlowExplorer catalogs={catalogs} />;
}
